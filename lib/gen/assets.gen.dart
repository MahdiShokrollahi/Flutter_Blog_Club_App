...
class $AssetsImgBackgroundGen {
  ...
  /// File path: assets/img/background/IMAGETILES.png
  AssetGenImage get imagetiles =>
      const AssetGenImage('assets/img/background/IMAGETILES.png');

  /// File path: assets/img/background/onboarding.png
  AssetGenImage get onboarding =>
      const AssetGenImage('assets/img/background/onboarding.png');

  /// File path: assets/img/background/placeholder.png
  AssetGenImage get placeholder =>
      const AssetGenImage('assets/img/background/placeholder.png');
...
class $AssetsImgIconsGen {
  ...
  /// File path: assets/img/icons/Grid.png
  AssetGenImage get grid => const AssetGenImage('assets/img/icons/Grid.png');
  ...
  /// File path: assets/img/icons/Table.png
  AssetGenImage get table => const AssetGenImage('assets/img/icons/Table.png');

  /// File path: assets/img/icons/Thumbs.png
  AssetGenImage get thumbs =>
      const AssetGenImage('assets/img/icons/Thumbs.png');
